...
print("Welcome to the wacky recipe generator. Please input the following:  ")
food= input("A favourite food:  ")
plant= input("A funky plant:  ")
item= input("A household item:  ")
cooking= input("method of cooking:  ")
burnt= input("A fancy cooking term for burnt food:  ")
print("Please enjoy tonight's dish of",cooking, food, "with", burnt, plant, "on a bed of", item,"!")
